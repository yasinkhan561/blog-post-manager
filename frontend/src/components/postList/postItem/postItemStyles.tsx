...
import { ColorKey, Spacing, TextSize, BorderRadius, BoxShadow, Breakpoint, TextWeight } from "@/theme/defaultTheme";
...
export const StyledCardFooter = styled.div`
  ...
  align-items: center;
  margin-top: ${Spacing.none}; 
  border-top: 1px solid ${({ theme }) => theme.colors[ColorKey.lightBorder]};
  padding: ${Spacing.sm};
`;
